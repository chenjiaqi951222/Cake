...
public interface CakeMapper {
     ...
     * @return  蛋糕集合
     */
    @Select("select id, category_id categoryId, name, lever, price, create_time createTime, update_time updateTime " +
     ...
     * @param cake  蛋糕信息
     */
    @Insert("insert into cake(category_id, name, lever, price, small_img, create_time, update_time) " +
            "value (#{cake.categoryId}, #{cake.name}, #{cake.lever}, #{cake.price}, #{cake.smallImg}, " +
